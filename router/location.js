...
apiRouter.post("/location", function (req, res) {
  ...
  switch (where) {
    ...
    case secondST:
      maplink =
        "https://map.kakao.com/link/map/제2과학기술대학,36.61104430370841, 127.28688799534845";
      break;
    case firstST:
      maplink =
        "https://map.kakao.com/link/map/제1과학기술대학,36.60999264660403, 127.2845548753664";
      break;
    case cultureSport:
      maplink =
        "https://map.kakao.com/link/map/문화스포츠관,36.61123638564794, 127.29073465209953";
      break;
    default:
